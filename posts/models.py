...
class Post(models.Model):
    ...
    meta_tags = models.CharField(max_length=259, blank=True)
    meta_desc = models.TextField(max_length=250, blank=True)
    slug = AutoSlugField(populate_from='title', max_length=250, unique=True, null=False)
    ...
    youtube = models.URLField(max_length=250, default='' )
    ...
    why_title = models.CharField(max_length=250, blank=True)
...
class offers(models.Model):
    ...
    button_url = models.URLField(max_length=250, default='', verbose_name='Button Link')
